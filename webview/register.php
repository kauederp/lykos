...
<div id="div-person-1" class="d-flex flex-column align-items-center">
	<div id="div-person-2">
		<i id="icon-person" class="bi bi-person"></i>
	</div>
</div>
<form method="POST" action="" class="fs-1 d-flex flex-column align-items-center">
	...
	<input pattern="[a-zA-z0-9]+$" class="col-8 bg-transparent text-center text-light border-bottom border-light" placeholder="Password" id="input-password-register" type="password" name="password">
	<br>
