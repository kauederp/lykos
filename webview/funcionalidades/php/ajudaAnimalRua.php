...
<body>
  ...
  <section id="cuidados">
    <br>
    <br>
    <div class="bars-column-kaue fw-bold col-11 text-start text-light p-3 mt-5">
        <p>1. Doe ração, acessórios e remédios veterinários</p>
        <p>2. Siga e compartilhe nas redes</p>
        <p>3. Ajude com dinheiro</p>
        <p>4. Abra suas portas temporariamente</p>
        <p>5. Divulgue notícias de maus tratos e de animais perdidos</p>
        <p>6. Adote um amigo</p>
       <p> 7. Faça trabalho voluntário</p>
        <p>8. Assine petições contra abusos</p>
        <p>9. Apadrinhe um animal</p>
        <p>10. Socorra ao ver um animal doente na rua</p>
    </div>
  </section>
