...
<body>
    ...
    <!-- limite -->
    <div>
      <div class="estrutura text-light">
        <p>Luisa Mell</p>
        <img class="iconl p-4" src="../IMAGENS PROJETO/luisa mell.png" alt="sitio 4 patas">
      </div>
      <div class="redes">
        <a href="https://www.instagram.com/luisamell/" target="_blank">
    ...
    <div>
      <div class="estrutura text-light">
        <p>Libertação Animal RS</p>
        <img class="iconl" src="../IMAGENS PROJETO/libertação animal.png" alt="">
      </div>
      <div class="redes">
        <a href="https://www.instagram.com/libertacaoanimalrs/" target="_blank">
          <img src="../IMAGENS PROJETO/instarede.png" alt="">
        </a>
      </div>
    </div>
